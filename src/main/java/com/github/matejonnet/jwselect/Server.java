...
/**
 see http://www.javaworld.com/article/2073344/core-java/use-select-for-high-speed-networking.html#resources
 */
public class Server implements Runnable {
    ...
    private boolean processInputAndWriteToOutput(SocketChannel sc) throws IOException {
        ...
        encrypt(buffer, read); //TODO should be done in worker thread
